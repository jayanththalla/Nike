...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* right side */}
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center cursor-pointer">
        <img 
        src={bigShoeImg}
        alt="show collection"
        width={610}
